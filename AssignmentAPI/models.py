...
class UserManager(BaseUserManager):
    def create_user(self, email, username, password=None):
        ...
        print(f'Password value from user: {password}')
        user = self.model(
...
class Advisor(models.Model):
    ...
    adv_profile_pic = models.ImageField(upload_to='images/')
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=False)

    def __str__(self):
        return f"{self.advisor_name} to advise {self.user}\n{self.adv_profile_pic}"
